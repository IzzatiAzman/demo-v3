...
gdjs.evtsExt__Player__AnimateFallingIntoPortal.asyncCallback18417332 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.75), (runtimeScene) => (gdjs.evtsExt__Player__AnimateFallingIntoPortal.asyncCallback18417332(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
