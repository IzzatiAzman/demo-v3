...
gdjs.Buttermilk_32ControlCode.GDbackObjects1= [];
gdjs.Buttermilk_32ControlCode.GDbackObjects2= [];
...
{for(var i = 0, len = gdjs.Buttermilk_32ControlCode.GDNextObjects1.length ;i < len;++i) {
    gdjs.Buttermilk_32ControlCode.GDNextObjects1[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 2 / 3);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Buttermilk_32ControlCode.GDbackObjects1.length;i<l;++i) {
    if ( gdjs.Buttermilk_32ControlCode.GDbackObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Buttermilk_32ControlCode.GDbackObjects1[k] = gdjs.Buttermilk_32ControlCode.GDbackObjects1[i];
        ++k;
    }
}
gdjs.Buttermilk_32ControlCode.GDbackObjects1.length = k;
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "923517cfc7f1500e851f0bbcdd357fe2b982745b128fcb3acc40d1a229575882_Click_02.aac", false, 70, 1);
...
gdjs.Buttermilk_32ControlCode.GDbackObjects1.length = 0;
gdjs.Buttermilk_32ControlCode.GDbackObjects2.length = 0;
