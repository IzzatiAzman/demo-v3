...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18194532);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11671652);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(21028940);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17912940);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18272580);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDPlayerObjects3 */
...
{for(var i = 0, len = gdjs.Level2Code.GDEndScreenSubHeaderObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenSubHeaderObjects2[i].getBehavior("Text").setText("Wow! You scored " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)) + " points within " + gdjs.evtTools.common.toString(Math.round(Math.abs(gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSeconds(runtimeScene, "Level")))) + " seconds!" + gdjs.evtTools.string.newLine() + "Submit your score to have a chance to win exclusive prizes now!");
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(21055420);
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("EndScreenSubHeader"), gdjs.Level2Code.GDEndScreenSubHeaderObjects2);
gdjs.copyArray(runtimeScene.getObjects("Main_Menu"), gdjs.Level2Code.GDMain_9595MenuObjects2);
...
for(var i = 0, len = gdjs.Level2Code.GDMain_9595MenuObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMain_9595MenuObjects2[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDContestObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDContestObjects2[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
}{for(var i = 0, len = gdjs.Level2Code.GDMain_9595MenuObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMain_9595MenuObjects2[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 2.5 / 4);
}
}{for(var i = 0, len = gdjs.Level2Code.GDRetryButtonObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDRetryButtonObjects2[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) / 4);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMain_9595MenuObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDMain_9595MenuObjects2[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDMain_9595MenuObjects2[k] = gdjs.Level2Code.GDMain_9595MenuObjects2[i];
        ++k;
    }
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(21053020);
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("player_input"), gdjs.Level2Code.GDplayer_9595inputObjects2);
...
}{runtimeScene.getScene().getVariables().get("User").getChild("name").setString((( gdjs.Level2Code.GDplayer_9595inputObjects2.length === 0 ) ? "" :gdjs.Level2Code.GDplayer_9595inputObjects2[0].getText()));
...
};gdjs.Level2Code.userFunc0x1453940 = function GDJSInlineCode(runtimeScene) {
"use strict";
if (!gdjs.landscape) {
...
gdjs.Level2Code.userFunc0x1453940(runtimeScene);
